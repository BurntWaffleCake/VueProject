!(function (e, t) {
  ...
  (() => {
    ...
    r.VantaBase = class {
      ...
      initThree() {
        n.WebGLRenderer
          ? ((this.renderer = new n.WebGLRenderer({ alpha: !0, antialias: !0 })), this.el.appendChild(this.renderer.domElement), this.applyCanvasStyles(this.renderer.domElement), isNaN(this.options.backgroundAlpha) && (this.options.backgroundAlpha = 1), (this.scene = new n.Scene()))
